...
> **Стабильность работы к сожалению не гарантируется. Мне нужно больше времени для глобальных изменений. Возможно ядро будет делится на rust и go. Любые ошибки прямо не оказывающие влияния на использование можно игнорировать.**
