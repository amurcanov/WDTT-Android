...
> Операторы связи и ТСПУ активно блокируют VPN-трафик. Применяют whitelist l3 cidr.
...
Любой Linux VPS (Ubuntu/Debian) с публичным IP. Реккомендуется использовать чистый сервер, так как программа работает с iptables
